...
seajs.config({
    alias:{
        ...
        "angular": "/gallery/angular/angularjs/1.2.3/angular",
        "zepto": "/gallery/zepto/1.1.3/zepto",
        "zepto_1.0": "/gallery/zepto/1.0.0/zepto",
        "mustache": "/gallery/mustache/0.7.0/mustache",
        "css3": "/utils/smallCss3/src/css3",
        ...
        'validator-core': '/arale/validator/0.9.2/core',
        'arale-calendar': '/arale/calendar/0.8.5/calendar',
        'widget': '/arale/widget/1.0.3/widget',
        'overlay': '/arale/overlay/1.0.1/overlay',

        // custom modules for mobile
        /*显示更多*/
        "showMore-m": "/mobile/styles/show_more/src/show_more",
        /*返回顶部*/
        "goTop-m": "/mobile/styles/goTop/src/goTop",
        /*税费计算器*/
        "taxCalculator-m": "mobile/styles/calculator/src/taxCalculator",
        /*房贷计算器*/
        "creditCalculator-m": "mobile/styles/calculator/src/creditCalculator",
        /*房贷税率*/
        "creditRate-m": "mobile/styles/calculator/src/creditRate",
        /*切签*/
        "goodTab-m": "mobile/styles/goodTab/src/goodTab",


        /*提示浮层*/
        "tips": "/mobile/styles/tips/src/tips",
        /*滚动底层库*/
        "iscroll": "/mobile/styles/iscroll/src/iscroll",
        /*滚动底层库，推荐*/
        "slider": "/mobile/styles/slider/src/slider",
        /*收藏*/
        "collect": "/mobile/utils/collect/src/collect",
        /*webSQL相关*/
        "webSQL": "/mobile/utils/webSQL/src/webSQL",
        /*滚动条组件*/
        "hiScrollBar": "/mobile/styles/hiScrollBar/src/hiScrollBar",
        // custom modules
        /*切签*/
        "goodTab": "/styles/goodTab/src/goodTab",
        /*下拉框*/
        "selectForm": "/styles/selectForm/src/selectForm",
        /*倒计时*/
        "countTime": "/utils/countTime/src/countTime",
        /*url辅助*/
        "url": "/utils/url/src/url",
        /*翻译后台返回的错误码*/
        "translateErrCode": "/utils/translateErrCode/src/translateErrCode",
        /*待补完*/
        "scrollView": "/styles/scrollView/src/scrollView",
        /*验证*/
        "validate": "/styles/validate/src/validate",
        /*输入辅助提示*/
        "suggest": "/styles/suggest/src/suggest",
        /*相册*/
        "ad-gallery": "/styles/ad-gallery/src/ad-gallery.js",
        /*待补完*/
        "slideView": "/styles/slideView/src/slideView.js",
        /*待补完*/
        "simpleslide": "/utils/simpleslide/src/simpleslide",
        /*查看更多*/
        "showMore": "/styles/showMore/src/showMore",
        /*创建flash*/
        "createFlashObj": "/utils/createFlashObj/src/createFlashObj.js",
        /*跨域post*/
        "crossDomainPost": "/utils/crossDomainPost/src/crossDomainPost.js",
        /*form序列化*/
        "serializeFormToJson": "/utils/serializeFormToJson/src/serializeFormToJson.js",
        // custom component
        /*保存搜索条件*/
        "saveCondition": "/styles/component/saveCondition/src/saveCondition",
        /*收藏项目*/
        "saveProject": "/styles/component/saveProject/src/saveProject",
        /*弹窗*/
        "dialog": "/styles/component/dialog/src/dialog",
        /*图片剪裁*/
        "icropper": "/styles/icropper/src/icropper",
        /*placeholder*/
        "placeholder": "/utils/placeholder/src/placeholder",
        /*密码强度*/
        "passwordStrength": "/utils/passwordStrength/src/jquery.passwordStrength.js",
        /*搜索*/
        "suggestSearch": "styles/suggestSearch/src/suggestSearch",
        /*首页搜索*/
        "headerSearch": "/styles/component/segment/src/headerSearch",
        /*返回顶部*/
        "goTop": "styles/component/goTop/src/goTop",
        /*登录弹窗*/
        "login": "styles/component/login/src/login",
        /*发送验证码*/
        "authCodeSending": "styles/component/authCodeSending/src/authCodeSending",
        /*表单提交验证*/
        "validateItemList": "styles/component/validateForm/src/validateItemList",
        /*补全用户信息*/
        "userInfo": "styles/component/userInfo/src/userInfo",
        /*google visualization chart*/
        "chart-core": "styles/chart/src/jsapi",
        /*日历*/
        "calendar": "styles/component/calendar/src/calendar.js",
        /*列表*/
        "itemList": "/utils/itemList/src/itemList",
        /*房贷计算器*/
        ...
        /*伪3D图片展示效果*/
        "slideGallery": "styles/slideGallery/src/slideGallery",
        /*移动版全景浏览*/
        "zeptoPanorama": "/mobile/styles/panorama/src/zepto.panorama_viewer.js"
