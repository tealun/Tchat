...
var u = o.type, a = w(u), f = a && b[a].type || n.type, l = "KB", c = Math.round(o.size / 1024 * 100) * .01, p = c;
...
if (!E(u, n.type)) return s.err(b[n.type + ""].msg), d.status = b[n.type + ""].tip, d.className = "error", !1;
if (c <= 0) return s.err("上传的文件不能为空"), !1;
if (!S(u, c, t)) return s.err(b[a + ""][t].msg), d.status = b[a + ""][t].tip, d.className = "error", !1;
